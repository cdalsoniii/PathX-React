...
import ResponsivenessTest from '../components/responsiveness-test'
...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Home - PathX</title>
        <meta property="og:title" content="Home - PathX" />
      </Helmet>
      <div data-role="Header" className="home-header-container">
        <Websiteheader rootClassName="websiteheader-root-class-name1"></Websiteheader>
        <ResponsivenessTest rootClassName="responsiveness-test-root-class-name"></ResponsivenessTest>
      ...
      <div className="home-footer">
        ...
        <Websiteheader rootClassName="websiteheader-root-class-name"></Websiteheader>
      </div>
    </div>
  )
}
